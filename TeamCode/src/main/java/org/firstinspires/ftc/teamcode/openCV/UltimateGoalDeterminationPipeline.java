...
public class UltimateGoalDeterminationPipeline extends OpenCvPipeline
{
    ...
    static final Point REGION_TOP_LEFT_ANCHOR_POINT = new Point(181,98);
    ...
    public void init(Mat firstFrame) {
        ...
        region_Cb = Cb.submat(new Rect(region_pointA, region1_pointB));
    }
